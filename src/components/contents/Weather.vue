      ...
      <div class="weather-current-header">
        <div class="header-content">
          ...
          <template v-if="selectedName">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" @click="refreshWeatherInfo"
    ...
    export default {
        ...
        methods: {
          refreshWeatherInfo () {
            const param = {
              // q : 'Incheon,kr',
              q: `${this.selectedName},${this.selectedContury}`,
              appid: API_KEY
            };
          ...
          getWeatherInfo (targetData) {
              ...
              this.selectedContury = targetData.country.toLowerCase();
